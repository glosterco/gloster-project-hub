              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Sistema inteligente que notifica automáticamente a todas las partes sobre estados de pago y documentos requeridos. Para mantener una comunicación clara entre mandantes y contratistas.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-brand-yellow flex-shrink-0 mt-1" />
