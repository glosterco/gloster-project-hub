-- Actualizar funciones que generan URLs con dominios incorrectos
-- Actualizar función ensure_contractor_urls
DROP FUNCTION IF EXISTS public.ensure_contractor_urls();
...
DROP FUNCTION IF EXISTS public.ensure_contractor_cc_urls();
...
-- Actualizar trigger function generate_contractor_cc_url
DROP FUNCTION IF EXISTS public.generate_contractor_cc_url();
...
DROP FUNCTION IF EXISTS public.set_contractor_url_for_new_payment();
