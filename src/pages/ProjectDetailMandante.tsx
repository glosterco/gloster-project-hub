...
const ProjectDetailMandante = () => {
  ...
  const getClosestPaymentToNotify = () => {
    ...
    const eligiblePayments = project.EstadosPago.filter((payment: any) => {
      ...
      console.log(
        `💰 Pago ${payment.id}: Status=${payment.Status}, URLContratista=${hasUrl ? "SÍ" : "NO"}, Elegible=${isEligible}`,
      );
      return isEligible;
    });
    ...
    const sortedPayments = eligiblePayments.sort(
  ...
  const filteredAndSortedPayments = project?.EstadosPago
    ? project.EstadosPago.filter((payment) => {
        const matchesSearch =
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <h4 className="font-semibold text-slate-800 font-rubik text-sm md:text-base">{payment.Name}</h4>
        ...
        <Card className="mb-6 border-l-4 border-l-gloster-gray hover:shadow-xl transition-all duration-300">
          <CardHeader className="pb-4">
            <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
              ...
              <Badge
                variant="secondary"
                className="bg-gloster-gray/20 text-gloster-gray border-gloster-gray/30 font-rubik self-start"
              >
        ...
        <div className="space-y-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="estados-pago" className="space-y-6">
              ...
              {renderControls(searchTerm, setSearchTerm, "Estado Extraordinario", () =>
            ...
            {presupuestoEnabled && (
              <TabsContent value="presupuesto" className="space-y-6">
                ...
                <div className="flex justify-center mt-6">
                  <Button
                    onClick={() =>
                      toast({ title: "Información", description: "Edita los valores de avance en la tabla" })
                    }
            ...
            {reunionesEnabled && (
              <TabsContent value="reuniones" className="space-y-6">
                ...
                {renderControls(reunionesSearch, setReunionesSearch, "Crear Minuta", () =>
                  toast({ title: "Función en desarrollo" }),
                )}
